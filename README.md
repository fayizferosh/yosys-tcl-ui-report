...
5 Day TCL training workshop by VSD using yosys opensource eda tools and TCL to generate a report from a design wherein the input is design file path in .csv format to tcl program.
